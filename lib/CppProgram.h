...
public:
	...
	string getCpp(const string& pn); // will throw an error if the Krom name doesn't exist
...
public:
	...
	void name(const string& in); // converts a Krom name to a posibly different C++ name
